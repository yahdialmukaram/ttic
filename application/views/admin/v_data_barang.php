                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$value['satuan'];?></td>
													<!-- <td><?="Rp. ".number_format($value['harga_sebelumnya']);?></td>
													<td><?="Rp. ".number_format($value['harga_sekarang']);?></td>
                        	<td><?="Rp. ".number_format($value['perubahan']);?></td>
		...
		<div class="modal-content">
          ...
          <div class="form-group">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <small>  <font color="red">nama barang wajib isi</font></small>    
            </div>
          </div>
